...
export default function GalleryHero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#00101010] via-[#00101050] to-[#00101080]"></div>
      ...
      <div className="relative z-10 text-center px-6 sm:px-8 md:px-10 text-white">
        ...
        <p
          ...
          data-aos-delay="200"
        >
          Moments that capture healing, strength, and transformation — from
