          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#b49559]">2017</div>
                  <div className="text-sm text-gray-600">Started Pilates Journey</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Completed from IPH New Delhi and IAMR, building a strong clinical foundation.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-[#5CE2E7]">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-2">
                      Balanced Body (USA) Pilates Instructor
                    </h3>
                    <p className="text-gray-600">
                      Internationally certified instructor guiding patients through mindful movement.
                    </p>
                  </div>
                </div>
              </div>
