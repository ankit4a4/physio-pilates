...
import heroImage from "@/assets/home/HomeAbout1.jpg";
...
export default function AboutHero() {
  ...
  return (
    ...
    >
      ...
      {/* Overlay Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#00101010] via-[#00101038] to-[#00101043]" />
      ...
      <div className="relative z-10 text-center px-6 sm:px-8 md:px-10 text-white">
        ...
        >
          Building{" "}
          <span className="text-[#b59659]">Strength</span>,{" "}
          <br className="hidden sm:block" /> Balance &{" "}
          <span className="text-[#5ce2e7]">Wellness</span> — Together
        </h1>
